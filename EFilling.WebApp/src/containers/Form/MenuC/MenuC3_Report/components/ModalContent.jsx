        ...
        >
          ...
          <div className="modal__body">
            ...
            <Col>
              ...
              <br />
              <Row>
                <Button color="success" disabled={(docId === '' ? true : !true)} onClick={() => this.printReportAgendaDraft()}>พิมพ์ร่าง</Button>{' '}
                <Button color="danger" disabled={(docId === '' ? true : isClosed)} onClick={() => this.printReportAgendaReal()}>พิมพ์จริง</Button>{' '}
              </Row>
            </Col>
            <Col>
              <Row>
              ...
              <br />
              <Row>
                <Button color="success" disabled={(docId === '' ? true : !true)} onClick={() => this.printReportMeetingDraft()}>พิมพ์ร่าง</Button>{' '}
                <Button color="danger" disabled={(docId === '' ? true : isClosed)} onClick={() => this.printReportMeetingReal()}>พิมพ์จริง</Button>{' '}
              </Row>
            </Col>
          </div>
