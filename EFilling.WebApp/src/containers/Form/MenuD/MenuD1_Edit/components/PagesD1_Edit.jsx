...
class PagesForm extends PureComponent {
  ...
  componentDidMount() {
    ...
    const rows = [];
    Axios
      .get(`PublicDocMenuD/MenuD1EditInterfaceData/${eFillingSys.registerId}/${urlParams.get('id')}`)
      .then((resp) => {
        ...
        if (resp.data.editdata.listRenewDate != null) {
          tbRows = resp.data.editdata.listRenewDate.map((e) => {
            tbRows = [];
            return e;
          });
        }
        ...
        this.setState({
          ...
          acceptProjectNo: resp.data.editdata.acceptprojectno,
          positionNameThai: resp.data.editdata.positionnamethai,
          ...
          acceptResult: resp.data.editdata.acceptresult,
          acceptResultName: resp.data.editdata.acceptresultname,
          acceptCondition: resp.data.editdata.acceptcondition,
          acceptConditionName: resp.data.editdata.acceptconditionname,
  ...
  handlePrintReport = () => {
    ...
    Axios
      .get(`PublicDocMenuReport/GetReportR9/${docId}`)
      .then((resp) => {
        if (resp.data !== null) {
          const url = resp.data.filebase64;
          const a = document.createElement('a');
          ...
          <CardBody>
            <form className="form" onSubmit={this.handleSubmit}>
              ...
              <div className="form__form-group">
                ...
                <div className="form__form-group-field">
                  <Field
                    ...
                    placeholder={acceptConditionName}
              ...
              <div className="form__form-group">
                ...
                <div className="form__form-group-field">
                  <Field
                    name="defaultAcceptDate"
                    placeholder={defaultAcceptDate}
                    component="input"
                    type="text"
                    disabled
                  />
