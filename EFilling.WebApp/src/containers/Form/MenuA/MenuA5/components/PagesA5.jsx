...
class PagesForm extends PureComponent {
  ...
  componentDidMount() {
    ...
    Axios
      .get(`PublicDocMenuA/MenuA5InterfaceData/${eFillingSys.registerId}`)
      .then((resp) => {
  ...
  handleChangeProjectNumber = (projectNumber) => {
    Axios
      .get(`PublicDocMenuA/GetProjectNumberWithDataA5/${projectNumber.value}`)
      .then((resp) => {
        ...
        this.setState({
          ...
          positionNameThai: resp.data.positionnamethai,
