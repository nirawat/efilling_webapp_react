...
class PagesForm extends PureComponent {
  ...
  componentDidMount() {
    ...
    Axios
      .get(`PublicDocMenuA/MenuA7EditInterfaceData/${eFillingSys.registerId}/${urlParams.get('id')}`)
      .then((resp) => {
  ...
  handlePrintReport = () => {
    ...
    Axios
      .get(`PublicDocMenuReport/GetReportR5/${docId}`)
      .then((resp) => {
        if (resp.data !== null) {
          const url = resp.data.filebase64;
          const a = document.createElement('a');
        ...
        <Card>
          <CardBody>
            <form className="form" onSubmit={this.handleSubmit}>
              ...
              <div className="form__form-group">
                <span className="form__form-group-label">
                  แนบรายงานผลสรุปและแจ้งปิดโครงการ
                </span>
                <div className="form__form-group-field">
                  <Field
                    id="file1Name"
